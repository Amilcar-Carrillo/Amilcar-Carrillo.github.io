...
| **Generative AI & Vector DB** | Retrieval-Augmented Generation (RAG), BigQuery Vector Search, Vertex AI (`text-embedding-004`, `gemini`), LangChain |
| **Ingeniería de Datos & ETL/ELT** | Python (Pandas, PySpark, Boto3, Requests), dbt, Apache Airflow, Docker, Pentaho PDI |
| **Bases de Datos & Data Warehouses** | Google BigQuery, AWS Athena, PostgreSQL, MySQL, SQL Server, MongoDB |
| **Business Intelligence & Analytics** | Power BI (DAX, Power Query, Data Gateways), Tableau (Desktop, Public), Looker Studio |
...
### 3. 📊 [Customer Churn & Revenue Attrition Analysis](https://github.com/Amilcar-Carrillo/customer-churn-revenue-analysis)
...
### 4. 🚕 [Análisis Geoespacial y Pruebas Estadísticas - Zuber](https://github.com/Amilcar-Carrillo/Zuber-Data-Engineering-Analysis)
...
### 5. 📈 [Market Trends & Content Performance Analytics](https://github.com/Amilcar-Carrillo/Analisis_Ventas_Tableau)
